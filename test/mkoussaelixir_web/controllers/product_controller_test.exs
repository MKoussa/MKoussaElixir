defmodule MkoussaelixirWeb.ProductControllerTest do
  use MkoussaelixirWeb.ConnCase

  import Mkoussaelixir.CatalogFixtures
  ...
  @invalid_attrs %{description: nil, title: nil, category: nil, price: nil, views: nil}
