defmodule MkoussaelixirWeb.CoreComponents do
  @moduledoc """
  ...
  import MkoussaelixirWeb.Gettext
  ...
  def simple_form(assigns) do
    ~H"""
    <.form :let={f} for={@for} as={@as} {@rest} class="core-simple-form">
      <div>
        <%= render_slot(@inner_block, f) %>
  ...
  def table(assigns) do
    ...
    <div>
      <table class="core-table">
        <thead>
          <tr class="core-table-item-title">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MkoussaelixirWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MkoussaelixirWeb.Gettext, "errors", msg, opts)
    end
  end
