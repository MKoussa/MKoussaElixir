defmodule MkoussaelixirWeb.UserAuth do
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      MkoussaelixirWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  Or use the `live_session` of your router to invoke the on_mount callback:
      ...
      live_session :authenticated, on_mount: [{MkoussaelixirWeb.UserAuth, :ensure_authenticated}] do
